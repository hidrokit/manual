\documentclass[11pt]{article}
    ...
    % Document parameters
    % Document title
    \title{taruma\_0\_4\_0\_hk172\_normal}
...
\begin{document}
    ...
    Berdasarkan isu
\href{https://github.com/hidrokit/hidrokit/issues/172}{\#172}:
\textbf{anfrek: Normal}

Referensi Isu: - Soewarno. (1995). hidrologi: Aplikasi Metode Statistik
untuk Analisa Data.NOVA. - Natural Resources Conversation Service.
(2007). Chapter 5: Stream Hydrology. Part 654 Stream Restoration Design
...
\PY{c+c1}{\PYZsh{} hidrologi: Aplikasi Metode Statistik untuk Analisa Data hal. 12}

\PY{n}{\PYZus{}DEBIT} \PY{o}{=} \PY{p}{[}
    \PY{l+m+mf}{149.4}\PY{p}{,} \PY{l+m+mf}{132.4}\PY{p}{,} \PY{l+m+mf}{125.0}\PY{p}{,} \PY{l+m+mf}{121.0}\PY{p}{,} \PY{l+m+mf}{114.7}\PY{p}{,} \PY{l+m+mf}{109.0}\PY{p}{,} \PY{l+m+mf}{101.7}\PY{p}{,} \PY{l+m+mf}{99.2}\PY{p}{,} \PY{l+m+mf}{97.8}\PY{p}{,} \PY{l+m+mf}{97.4}\PY{p}{,} \PY{l+m+mf}{91.1}\PY{p}{,} 
    \PY{l+m+mf}{90.0}\PY{p}{,} \PY{l+m+mf}{89.1}\PY{p}{,} \PY{l+m+mf}{84.6}\PY{p}{,} \PY{l+m+mf}{83.8}\PY{p}{,} \PY{l+m+mf}{83.6}\PY{p}{,} \PY{l+m+mf}{78.6}\PY{p}{,} \PY{l+m+mf}{77.8}\PY{p}{,} \PY{l+m+mf}{73.0}\PY{p}{,} \PY{l+m+mf}{68.5}\PY{p}{,} \PY{l+m+mf}{65.0}\PY{p}{,} \PY{l+m+mf}{45.2}\PY{p}{,} \PY{l+m+mf}{41.6}
\PY{p}{]}

\PY{c+c1}{\PYZsh{} Data aslinya Tabel 3.4}
\PY{c+c1}{\PYZsh{} 109.0, 125.0, 121.0, 97.4, 78.6, 149.4, 90.0, 114.1, 91.1, 84.6, 132.4, }
\PY{c+c1}{\PYZsh{} 83.8, 73.0, 65.0, 97.8, 77.8, 45.2, 68.5, 83.6, 191.7, 99.2, 41.6, 89.1}
\PY{c+c1}{\PYZsh{} terdapat perbedaan nilai (max seharusnya 191.7) dan nilai 114.1 \PYZhy{}\PYZgt{} 114.7}

\PY{n}{data} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{DataFrame}\PY{p}{(}
    \PY{n}{data}\PY{o}{=}\PY{n}{\PYZus{}DEBIT}\PY{p}{,} \PY{n}{columns}\PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{debit}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{index}\PY{o}{=}\PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{24}\PY{p}{)}
\PY{p}{)}
...
Terdapat 1 tabel untuk modul \texttt{hk172} yaitu: -
...
Dalam modul \texttt{hk172} nilai \(k\) akan dibangkitkan menggunakan
...
\PY{k}{def} \PY{n+nf}{calc\PYZus{}x\PYZus{}normal}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{return\PYZus{}period}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{5}\PY{p}{]}\PY{p}{,} \PY{n}{source}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{scipy}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{show\PYZus{}stat}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}\PY{p}{:}
    \PY{n}{return\PYZus{}period} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{return\PYZus{}period}\PY{p}{)}
...
\PY{k}{def} \PY{n+nf}{freq\PYZus{}normal}\PY{p}{(}
    ...
    \PY{n}{col\PYZus{}name}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Normal}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{index\PYZus{}name}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Kala Ulang}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{:}
    ...
    \PY{n}{arr} \PY{o}{=} \PY{n}{calc\PYZus{}x\PYZus{}normal}\PY{p}{(}
...
Catatan: Fungsi ini sama dengan \texttt{.hk124}.
...
k scipy     = [0.         0.84162123 1.28155157 1.50108595 1.64485363 1.75068607
 1.78615556 2.05374891 2.32634787]
    ...
    \hypertarget{fungsi-calc_x_normalx-...}{%
\subsection{\texorpdfstring{Fungsi
\texttt{calc\_x\_normal(x,\ ...)}}{Fungsi calc\_x\_normal(x, ...)}}\label{fungsi-calc_x_normalx-...}}

Function:
\texttt{calc\_x\_normal(x,\ return\_period={[}5{]},\ source=\textquotesingle{}scipy\textquotesingle{},\ show\_stat=False)}
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{calc\PYZus{}x\PYZus{}normal}\PY{p}{(}\PY{n}{data}\PY{o}{.}\PY{n}{debit}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{calc\PYZus{}x\PYZus{}normal}\PY{p}{(}\PY{n}{data}\PY{o}{.}\PY{n}{debit}\PY{p}{,} \PY{n}{show\PYZus{}stat}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{calc\PYZus{}x\PYZus{}normal}\PY{p}{(}\PY{n}{data}\PY{o}{.}\PY{n}{debit}\PY{p}{,} \PY{n}{return\PYZus{}period}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{10}\PY{p}{,} \PY{l+m+mi}{15}\PY{p}{,} \PY{l+m+mi}{20}\PY{p}{,} \PY{l+m+mi}{21}\PY{p}{]}\PY{p}{,} \PY{n}{show\PYZus{}stat}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{freq\PYZus{}normal}\PY{p}{(}\PY{n}{data}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{freq\PYZus{}normal}\PY{p}{(}\PY{n}{data}\PY{p}{,} \PY{n}{source}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{soewarno}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{col\PYZus{}name}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Log Normal (Soewarno)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{freq\PYZus{}normal}\PY{p}{(}\PY{n}{data}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{debit}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{source}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{scipy}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{col\PYZus{}name}\PY{o}{=}\PY{l+s+sa}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{LP3 (scipy)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{show\PYZus{}stat}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
