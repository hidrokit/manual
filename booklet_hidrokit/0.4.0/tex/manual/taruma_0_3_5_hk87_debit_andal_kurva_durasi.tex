\documentclass[11pt]{article}
    ...
    % Document parameters
    % Document title
    \title{taruma\_0\_3\_5\_hk87\_debit\_andal\_kurva\_durasi}
...
Referensi isu: - SNI 6738:2015: \textbf{Perhitungan debit andalan sungai
dengan kurva durasi debit}. Pranala:
\href{http://sni.litbang.pu.go.id/index.php?r=/sni/new/sni/detail/id/458}{sni.litbang.pu.go.id}
diakses 10 desember 2019.

Deskripsi Permasalahan: - Mencari nilai debit andal pada \(Q_{80}\),
\(Q_{90}\), dan \(Q_{95}\) pada periode tertentu (dalam satu tahun, atau
setiap bulan).

Strategi Penyelesaian Masalah: - Mengikuti panduan SNI 6738:2015. -
...
Menyusun berurutan nilai dalam dataframe. - Membuat \texttt{list/array}
yang merupakan nilai (kumulatif) probabilitas. - Mengembalikan d -
Mencari nilai \(Q_{80}\), \(Q_{90}\), dan \(Q_{95}\)

Catatan: - Dataset yang digunakan serupa dengan lampiran A dalam SNI
6738:2015.
...
\emph{tuple} berisi dua \texttt{np.array} yaitu \texttt{x} (untuk sumbu
x, probabilitas weibull) dan \texttt{y} (untuk sumbu y, nilai debit yang
telah diurutkan). - \texttt{\textquotesingle{}table\textquotesingle{}}
(\textbf{default}) : keluaran berupa \texttt{pandas.DataFrame} tabelaris
yang berisikan kolom \texttt{idx} (indeks/tanggal kejadian),
\texttt{rank} (ranking), \texttt{prob} (probabilitas weibull),
\texttt{data} (nilai yang telah diurutkan). -
...
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{len(x) = }\PY{l+s+si}{\PYZob{}}\PY{n+nb}{len}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{l+s+si}{\PYZcb{}}\PY{l+s+se}{\PYZbs{}t}\PY{l+s+s1}{x[:5] = }\PY{l+s+si}{\PYZob{}}\PY{n}{x}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{5}\PY{p}{]}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{len(y) = }\PY{l+s+si}{\PYZob{}}\PY{n+nb}{len}\PY{p}{(}\PY{n}{y}\PY{p}{)}\PY{l+s+si}{\PYZcb{}}\PY{l+s+se}{\PYZbs{}t}\PY{l+s+s1}{y[:5] = }\PY{l+s+si}{\PYZob{}}\PY{n}{y}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{5}\PY{p}{]}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{keys = }\PY{l+s+si}{\PYZob{}}\PY{n}{bulanan}\PY{o}{.}\PY{n}{keys}\PY{p}{(}\PY{p}{)}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{values = }\PY{l+s+si}{\PYZob{}}\PY{n+nb}{type}\PY{p}{(}\PY{n}{bulanan}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
