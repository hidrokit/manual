...
\item
  Saat menggabungkan diperiksa juga kondisi data (cek \emph{invalid}).
\end{itemize}
...
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{shape = }\PY{l+s+si}{\PYZob{}array.shape\PYZcb{}}\PY{l+s+s1}{; type = }\PY{l+s+si}{\PYZob{}array.dtype\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
