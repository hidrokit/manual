...
\tightlist
\item
  Urutan pengembangan dari Blaney-Criddle, Radiasi, kemudian diakhiri
  Penman. Beberapa tabel yang digunakan pada Penman tersedia pada rumus
  sebelumnya.
\item
  ...
  \tightlist
  \item
    Tabel \texttt{rel\_P\_LL}, hubungan \(P\) dan Letak Lintang (LL)
    (Untuk Indonesia \(5^{\circ}\) s/d \(10^{\circ} \text{LS}\)).
  \item
    Tabel \texttt{cor\_C\_BC}, angka koreksi \(C\) menurut Blaney
    Criddle.
  \item
    Tabel \texttt{rel\_T\_W}, hubungan \(T\) dan \(W\) (untuk Indonesia,
    El. \(0-500\ \text{m}\))
  \item
    Tabel \texttt{cor\_C\_RAD}, angka koreksi \(C\) menurut Rumus
    Radiasi.
  \item
    Tabel \texttt{val\_Rg}, harga \(R_\gamma\) (Untuk Indonesia
    \(5^{\circ}\ \text{LU}\) s/d \(10^{\circ}\ \text{LS}\)).
  \item
    Tabel \texttt{cor\_C\_PEN}, angka koreksi \(C\) menurut Penman.
  \item
    Tabel \texttt{rel\_T\_PEN}, hubungan \(T\) dengan
    \(\varepsilon_\gamma, W, F(T)\).
  \end{itemize}
\item
  Pengembangan fungsi mengikuti \texttt{hk89.model\_NRECA()}.
\end{itemize}
...
\PY{n}{t\PYZus{}rel\PYZus{}P\PYZus{}LL} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{DataFrame}\PY{p}{(}\PY{p}{\PYZob{}}
    ...
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{0}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}        \PY{p}{[}\PY{o}{.}\PY{l+m+mi}{27}\PY{p}{]}\PY{o}{*}\PY{l+m+mi}{12}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{2.5 S}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}    \PY{p}{[}\PY{o}{.}\PY{l+m+mi}{28}\PY{p}{]}\PY{o}{*}\PY{l+m+mi}{12}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{5 S}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}      \PY{p}{[}\PY{o}{.}\PY{l+m+mi}{28}\PY{p}{]}\PY{o}{*}\PY{l+m+mi}{12}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{7.5 S}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}    \PY{p}{[}\PY{o}{.}\PY{l+m+mi}{28}\PY{p}{]}\PY{o}{*}\PY{l+m+mi}{4} \PY{o}{+} \PY{p}{[}\PY{o}{.}\PY{l+m+mi}{27}\PY{p}{]}\PY{o}{*}\PY{l+m+mi}{4} \PY{o}{+} \PY{p}{[}\PY{o}{.}\PY{l+m+mi}{28}\PY{p}{]}\PY{o}{*}\PY{l+m+mi}{3} \PY{o}{+} \PY{p}{[}\PY{o}{.}\PY{l+m+mi}{29}\PY{p}{]}\PY{o}{*}\PY{l+m+mi}{1}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{10 S}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}     \PY{p}{[}\PY{o}{.}\PY{l+m+mi}{29}\PY{p}{]} \PY{o}{+} \PY{p}{[}\PY{o}{.}\PY{l+m+mi}{28}\PY{p}{]}\PY{o}{*}\PY{l+m+mi}{2} \PY{o}{+} \PY{p}{[}\PY{o}{.}\PY{l+m+mi}{27}\PY{p}{]} \PY{o}{+} \PY{p}{[}\PY{o}{.}\PY{l+m+mi}{26}\PY{p}{]}\PY{o}{*}\PY{l+m+mi}{4} \PY{o}{+} \PY{p}{[}\PY{o}{.}\PY{l+m+mi}{27}\PY{p}{]} \PY{o}{+}\PY{p}{[}\PY{o}{.}\PY{l+m+mi}{28}\PY{p}{]}\PY{o}{*}\PY{l+m+mi}{2} \PY{o}{+} \PY{p}{[}\PY{o}{.}\PY{l+m+mi}{29}\PY{p}{]}
...
\PY{n}{t\PYZus{}cor\PYZus{}C\PYZus{}BC} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{DataFrame}\PY{p}{(}\PY{p}{\PYZob{}}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{C}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}    \PY{p}{[}\PY{o}{.}\PY{l+m+mi}{8}\PY{p}{,} \PY{o}{.}\PY{l+m+mi}{8}\PY{p}{,} \PY{o}{.}\PY{l+m+mi}{75}\PY{p}{,} \PY{o}{.}\PY{l+m+mi}{7}\PY{p}{,} \PY{o}{.}\PY{l+m+mi}{7}\PY{p}{,} \PY{o}{.}\PY{l+m+mi}{7}\PY{p}{,} \PY{o}{.}\PY{l+m+mi}{7}\PY{p}{,} \PY{o}{.}\PY{l+m+mi}{75}\PY{p}{,} \PY{o}{.}\PY{l+m+mi}{8}\PY{p}{,} \PY{o}{.}\PY{l+m+mi}{8}\PY{p}{,} \PY{o}{.}\PY{l+m+mi}{8}\PY{p}{,} \PY{o}{.}\PY{l+m+mi}{8}\PY{p}{]}
\PY{p}{\PYZcb{}}\PY{p}{,} \PY{n}{index}\PY{o}{=}\PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{13}\PY{p}{)}\PY{p}{)}
...
\PY{n}{t\PYZus{}rel\PYZus{}T\PYZus{}W} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{DataFrame}\PY{p}{(}\PY{p}{\PYZob{}}
    ...
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{W}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mf}{0.735}\PY{p}{,} \PY{l+m+mf}{0.794}\PY{p}{,} \PY{o}{.}\PY{l+m+mi}{002}\PY{p}{)}
\PY{p}{\PYZcb{}}\PY{p}{)}

\PY{n}{t\PYZus{}cor\PYZus{}C\PYZus{}RAD} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{DataFrame}\PY{p}{(}
    \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{C}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{[}\PY{o}{.}\PY{l+m+mi}{8}\PY{p}{]}\PY{o}{*}\PY{l+m+mi}{2} \PY{o}{+} \PY{p}{[}\PY{o}{.}\PY{l+m+mi}{75}\PY{p}{]}\PY{o}{*}\PY{l+m+mi}{5} \PY{o}{+} \PY{p}{[}\PY{o}{.}\PY{l+m+mi}{8}\PY{p}{]}\PY{o}{*}\PY{l+m+mi}{5}\PY{p}{\PYZcb{}}\PY{p}{,}
...
\PY{n}{t\PYZus{}cor\PYZus{}C\PYZus{}PEN} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{DataFrame}\PY{p}{(}\PY{p}{\PYZob{}}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{C}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{[}\PY{l+m+mf}{1.1}\PY{p}{]}\PY{o}{*}\PY{l+m+mi}{3} \PY{o}{+} \PY{p}{[}\PY{o}{.}\PY{l+m+mi}{9}\PY{p}{]}\PY{o}{*}\PY{l+m+mi}{4} \PY{o}{+} \PY{p}{[}\PY{l+m+mf}{1.1}\PY{p}{]}\PY{o}{*}\PY{l+m+mi}{5}\PY{p}{,}
\PY{p}{\PYZcb{}}\PY{p}{,} \PY{n}{index}\PY{o}{=}\PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{13}\PY{p}{)}\PY{p}{)}

\PY{n}{t\PYZus{}rel\PYZus{}T\PYZus{}PEN} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{DataFrame}\PY{p}{(}\PY{p}{\PYZob{}}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{suhu}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mf}{24.}\PY{p}{,} \PY{l+m+mf}{29.1}\PY{p}{,} \PY{o}{.}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{,}
    ...
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{w}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mf}{0.735}\PY{p}{,} \PY{l+m+mf}{0.786}\PY{p}{,} \PY{o}{.}\PY{l+m+mi}{002}\PY{p}{)}\PY{p}{,}
...
\PY{k}{def} \PY{n+nf}{BC\PYZus{}ETo\PYZus{}x}\PY{p}{(}\PY{n}{P}\PY{p}{,} \PY{n}{temp}\PY{p}{)}\PY{p}{:}
    \PY{k}{return} \PY{n}{P} \PY{o}{*} \PY{p}{(}\PY{o}{.}\PY{l+m+mi}{457}\PY{o}{*}\PY{n}{temp} \PY{o}{+} \PY{l+m+mf}{8.13}\PY{p}{)}
